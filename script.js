...
function getWordsForCurrentDay() {
    ...
    switch (today) {
        ...
        case "2024-07-03":
            ...
            break;
        default:
            themeHeader.innerText = "We are not playing today im afraid. The game will return one day"; // Handle any other day (optional)
            break;
    }
